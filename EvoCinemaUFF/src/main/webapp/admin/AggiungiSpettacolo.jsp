...
<form method="POST" action="">
  <div class="form-group">
    ...
    <select class="form-control" id="select-film" required>
        <option>da completare con ajax</option>
    </select>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" placeholder="Titolo" id="titolo-spettacolo" required>
  </div>
  <div class="form-group">
    <label for="select-sala" >Sala </label>
    <select class="form-control" id="select-sala" required>
        <option>da completare con ajax</option>
    </select>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="time" class="form-control" id="ora-inizio" required>
  ...
  <div class="form-group">
    ...
    <input type="time" class="form-control" id="ora-fine" required>
    <small id="ora-fine-help" class="form-text text-muted">Seleziona l'orario in cui lo spettacolo terminerà.</small>
  </div>
  <div class="form-group">
    <label for="prezzo" >Prezzo:</label>
    <input type="number" class="form-control" id="prezzo" step="any" required>
  </div>
