 ...
 */
@WebServlet( name = "AggiuntaSconto" , urlPatterns = { "/admin/aggiuntaSconto" } )
...
public class AggiuntaScontoCNT extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String messaggio = "Impossibile completare l'inserimento";
        ...
        try {
            ...
            Sconto sconto = new Sconto(nome, percentuale, prezzo, parametroTipologia, verificabile, tipoSconto, Sconto.disponibile.TRUE, tipologia);

            ScontoDAO dao = new ScontoDAO();
            
            dao.createSconto(sconto);
